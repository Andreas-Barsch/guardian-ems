...
DIAGNOSTIC_OPTION_KEYS = (
    ...
    "cell_diag_trend_min_days",
    "cell_diag_trend_min_rank_change",
    "cell_diag_trend_min_deviation_change_mv",
    "cell_diag_resistance_min_delta_current_a",
    "cell_diag_resistance_max_step_seconds",
    "cell_diag_resistance_min_events",
    "cell_diag_resistance_window_samples",
    "cell_diag_resistance_max_current_span_a",
    "cell_diag_resistance_max_relative_mad",
    "cell_diag_quality_max_temperature_change_c",
    "cell_diag_sequence_max_gap_seconds",
    "cell_diag_sequence_min_samples",
    "cell_diag_sequence_min_duration_seconds",
    "cell_diag_sequence_min_charge_ah",
    "cell_diag_sequence_min_segments",
    "cell_diag_rest_max_current_a",
    "cell_diag_rest_min_duration_seconds",
    "cell_diag_balancing_min_active_samples",
    "cell_diag_ica_min_samples",
    "cell_diag_ica_max_current_cv",
    "cell_diag_ica_min_voltage_steps",
    "cell_diag_maintenance_context_window_hours",
    "cell_diag_relative_trend_change_percent",
    "cell_diag_aggregate_retention_days",
    "cell_diag_capacity_boundary_fraction",
    "cell_diag_capacity_max_crossing_mad_fraction",
    "cell_diag_curve_grid_points",
    "cell_diag_curve_max_rms_mad_mv",
)
