...
<main>
  ...
  <section id="list-view" class="panel">
    ...
    <form id="filter-form" class="filters">
      ...
      <label><span>Archiv</span><select id="filter-archived"><option value="false">Archivierte ausblenden</option><option value="true">Archivierte anzeigen</option></select></label>
  ...
  <section id="detail-view" class="panel" hidden>
    ...
    <div class="actions"><button id="edit-button" class="primary" type="button">Bearbeiten</button><button id="archive-button" class="danger" type="button">Archivieren</button><button id="restore-button" type="button" hidden>Wiederherstellen</button></div>
  ...
  <section id="form-view" class="panel" hidden>
    ...
    <form id="event-form" class="form-grid">
      ...
      <label>Modul-Seriennummer <input id="module-serial" maxlength="200"></label>
      <label>Zelle <select id="cell-number"><option value="">Keine Zelle</option></select></label>
